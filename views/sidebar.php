<aside class="main-sidebar elevation-1 sidebar-dark-warning">
   <?php $data = sitedata();  ?>
   <a href="<?= base_url(); ?>/dashboard" class="brand-link" style="background-color: #6e6e6ea6;">
   <img src="<?= base_url().'assets/uploads/'.$data['s_logo'] ?>" class="brand-image img-circle elevation-1 frlogo">
   <span class="brand-text font-weight-light"><?php echo ucfirst("MarteX Transport"); ?></span>
   </a>
   <div class="sidebar">
      <nav class="mt-2">
