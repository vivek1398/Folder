              ...
              <form id="addnewcategory" class="basicvalidation" role="form" action="<?php echo base_url(); ?>settings/smtpconfigsave" method="post"  enctype='multipart/form-data'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <button type="button" data-toggle="modal" data-target="#modal-default" class="btn btn-dark">Test Email</button>
                    <button type="submit" class="btn btn-dark">Save Config</button>
                  </div>
