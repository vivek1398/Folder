            ...
            <div class="col-md-6">
               <div class="card">
                     ...
                     <ul class="todo-list ui-sortable" data-widget="todo-list">
                        ...
                        <li id="<?= $reminder['r_id'] ?>">
                           <span class="text">
                              <?= $reminder['r_message']. ' ';  ?>    
                              <div class="tools"> 
                                 <button type="button" data-id="<?= $reminder['r_id'] ?>" class="todayreminderread btn btn-block btn-outline-dark btn-xs">Mark as Read</button>                 
                              </div>
                           </span>
                        </li>
                  ...
                  <div class="card-footer clearfix">
                     <a href="<?= base_url() ?>reminder/addreminder"><button type="button" class="btn btn-dark float-right"><i class="fas fa-plus"></i> Add Reminder</button></a>
                  </div>
               </div>
            </div>
         </div>
